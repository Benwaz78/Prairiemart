...
urlpatterns = [
    ...
    url(r'^category-grid-page/(?P<category_slug>[-\w]+)/$', views.category_grid, name='category_grid'),
    url(r'^product-detail-page/(?P<id>\d+)/(?P<slug>[-\w]+)/$', views.product_detail, name='product_detail'),
